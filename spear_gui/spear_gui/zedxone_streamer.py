...
# camera-resolution enum values for zedxonesrc.
# VERIFY with: gst-inspect-1.0 zedxonesrc
# HD1200/QHDPLUS/4K are confirmed from the docs; HD1080 and SVGA are assumed.
RESOLUTIONS = {
    "SVGA": 0,
    "HD1080": 1,
    "HD1200": 2,
...
# 30 FPS is valid for every zedxonesrc resolution.
FPS = 30
...
class ZedXOneStreamer(Node):
    ...
    def on_restart(self, request, response):
        ...
        #   {"camera_sn": 302801647, "resolution": "HD1200", "bitrate": 4000000}
